...
const idAndRank = todo.pick({ id: true, rank: true }).required()
...
todoRouter.put(
  ...
  customRouteFunction(moveToTodo)
)
todoRouter.put(
  "/progress/move",
  customRouteFunction(bodyValidator(id)),
  customRouteFunction(moveTOProgress)
)
todoRouter.put(
  "/testing/move",
  customRouteFunction(bodyValidator(id)),
  customRouteFunction(moveToTest)
)
todoRouter.put(
  "/done/move",
  customRouteFunction(bodyValidator(id)),
  customRouteFunction(moveToDone)
)
// route for moving to same card
todoRouter.put(
  "/move",
  customRouteFunction(bodyValidator(idAndRank)),
  customRouteFunction(moveOnSame)
)
